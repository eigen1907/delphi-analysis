...
def main() -> None:
    ...
    from plot_gen_reco_track_match_result import plot_gen_reco_track_match_result

    input_root = args.input
    output_root = args.output or default_plot_root(PROJECT_ROOT, input_root)
    plot_gen_reco_track_match_result(input_root, output_root, args.alpha_cut, args.fiducial_cos_max, args.pt_min, args.samples)
